...
Repo for the ArgentBank project from OpenClassrooms' JS-React path.
...
I added tests using Vitest, React Testing library and the Mock Service Workers library.
